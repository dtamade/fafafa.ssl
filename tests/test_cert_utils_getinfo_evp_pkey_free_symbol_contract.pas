program test_cert_utils_getinfo_evp_pkey_free_symbol_contract;
...
procedure AssertEVPPKeyFreeGuardInfo(
  const AName: string;
...
procedure TestGetInfoShouldFailGracefullyWhenEVPPKeyFreeIsUnavailable;
var
  LFixturePEM: string;
...
begin
  WriteLn;
  WriteLn('=== Certificate utils GetInfo EVP_PKEY_free symbol guard ===');
  ...
  begin
    MarkSkip('certificate utils getinfo EVP_PKEY_free symbol contract',
  ...
  try
    AssertGetInfoSafeDegrade(
      'GetInfo when EVP_PKEY_free is unavailable',
      LFixturePEM,
      LExpectedSubject,
      LExpectedIssuer,
      LExpectedVersion,
...
begin
  WriteLn('========================================');
  WriteLn('Certificate Utils GetInfo EVP_PKEY_free Symbol Contract Test');
  WriteLn('========================================');
  ...
  try
    ...
    if SkippedTests = 0 then
      TestGetInfoShouldFailGracefullyWhenEVPPKeyFreeIsUnavailable;
