...
function StubSSLGetPeerCertChain(const ssl: PSSL): fafafa.ssl.openssl.base.PSTACK_OF_X509; cdecl;
begin
...
function StubSkX509Num(const st: fafafa.ssl.openssl.api.stack.PSTACK_OF_X509): Integer; cdecl;
begin
