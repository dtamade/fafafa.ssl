...
begin
  ...
  try
    ...
    try
      ...
      Test('Serialize returns i2d-generated bytes after deserialize',
        (Length(LData) = Length(STUB_WOLFSSL_SERIALIZED_SESSION)) and
        CompareMem(@LData[0], @STUB_WOLFSSL_SERIALIZED_SESSION[0],
          Length(STUB_WOLFSSL_SERIALIZED_SESSION)));
