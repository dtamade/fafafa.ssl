...
var
  SSLLib: TOpenSSLLibrary;
  LOrigPKCS12Parse: fafafa.ssl.openssl.api.pkcs12.TPKCS12_parse;
  LCaps: TSSLBackendCapabilities;
...
begin
  ...
  try
    ...
    LSurfaceReady := Assigned(fafafa.ssl.openssl.api.pkcs12.PKCS12_create) and
      Assigned(fafafa.ssl.openssl.api.pkcs12.PKCS12_parse) and
      Assigned(fafafa.ssl.openssl.api.pkcs12.d2i_PKCS12_bio) and
      Assigned(fafafa.ssl.openssl.api.pkcs12.i2d_PKCS12_bio);
    LCaps := SSLLib.GetCapabilities;
  ...
  try
    ...
    LOrigPKCS12Parse := fafafa.ssl.openssl.api.pkcs12.PKCS12_parse;
    ...
    fafafa.ssl.openssl.api.pkcs12.PKCS12_parse := nil;
    try
      LCaps := SSLLib.GetCapabilities;
      Require(not LCaps.SupportsPKCS12,
        'PKCS#12 capability must stop claiming supported when PKCS12_parse is not runtime-ready');
    finally
      fafafa.ssl.openssl.api.pkcs12.PKCS12_parse := LOrigPKCS12Parse;
    end;
...
var
  ...
  LOrigD2IX509Sig: fafafa.ssl.openssl.api.pkcs.Td2i_X509_SIG;
  LOrigPKCS8Decrypt: fafafa.ssl.openssl.api.pkcs12.TPKCS8_decrypt;
...
begin
  ...
  try
    ...
    LOrigD2IX509Sig := fafafa.ssl.openssl.api.pkcs.d2i_X509_SIG;
    LOrigPKCS8Decrypt := fafafa.ssl.openssl.api.pkcs12.PKCS8_decrypt;
    ...
    try
      ...
      fafafa.ssl.openssl.api.pkcs.d2i_X509_SIG := LOrigD2IX509Sig;
      fafafa.ssl.openssl.api.pkcs12.PKCS8_decrypt := LOrigPKCS8Decrypt;
...
var
  ...
  LOrigPEMReadPrivateKey: TPEM_read_bio_PrivateKey;
  LOrigUsePrivateKeyFile: TSSL_CTX_use_PrivateKey_file;
  LOrigD2IPKCS8PrivateKeyInfo: fafafa.ssl.openssl.api.pkcs.Td2i_PKCS8_PRIV_KEY_INFO;
  LOrigD2IRSAPrivateKey: Td2i_RSAPrivateKey;
  LOrigEVPPKEYNew: TEVP_PKEY_new;
  LOrigEVPPKEYSet1RSA: TEVP_PKEY_set1_RSA;
begin
  ...
  try
    ...
    LOrigPEMReadPrivateKey := PEM_read_bio_PrivateKey;
    LOrigUsePrivateKeyFile := SSL_CTX_use_PrivateKey_file;
    LOrigD2IPKCS8PrivateKeyInfo := fafafa.ssl.openssl.api.pkcs.d2i_PKCS8_PRIV_KEY_INFO;
    LOrigD2IRSAPrivateKey := d2i_RSAPrivateKey;
    LOrigEVPPKEYNew := EVP_PKEY_new;
    LOrigEVPPKEYSet1RSA := EVP_PKEY_set1_RSA;
    ...
    try
      ...
      PEM_read_bio_PrivateKey := LOrigPEMReadPrivateKey;
      SSL_CTX_use_PrivateKey_file := LOrigUsePrivateKeyFile;
      fafafa.ssl.openssl.api.pkcs.d2i_PKCS8_PRIV_KEY_INFO := LOrigD2IPKCS8PrivateKeyInfo;
      d2i_RSAPrivateKey := LOrigD2IRSAPrivateKey;
      EVP_PKEY_new := LOrigEVPPKEYNew;
      EVP_PKEY_set1_RSA := LOrigEVPPKEYSet1RSA;
    end;
...
var
  ...
  LCaps: TSSLBackendCapabilities;
  LOrigD2IPKCS8PrivateKeyInfo: fafafa.ssl.openssl.api.pkcs.Td2i_PKCS8_PRIV_KEY_INFO;
  LOrigEVPPKCS82PKEY: fafafa.ssl.openssl.api.pkcs.TEVP_PKCS82PKEY;
  LOrigD2IX509Sig: fafafa.ssl.openssl.api.pkcs.Td2i_X509_SIG;
  LOrigPKCS8Decrypt: fafafa.ssl.openssl.api.pkcs12.TPKCS8_decrypt;
  LOrigD2IRSAPrivateKey: Td2i_RSAPrivateKey;
...
begin
  ...
  try
    ...
    LOrigD2IPKCS8PrivateKeyInfo := fafafa.ssl.openssl.api.pkcs.d2i_PKCS8_PRIV_KEY_INFO;
    LOrigEVPPKCS82PKEY := fafafa.ssl.openssl.api.pkcs.EVP_PKCS82PKEY;
    LOrigD2IX509Sig := fafafa.ssl.openssl.api.pkcs.d2i_X509_SIG;
    LOrigPKCS8Decrypt := fafafa.ssl.openssl.api.pkcs12.PKCS8_decrypt;
    LOrigD2IRSAPrivateKey := d2i_RSAPrivateKey;
    ...
    try
      ...
      fafafa.ssl.openssl.api.pkcs.d2i_PKCS8_PRIV_KEY_INFO := LOrigD2IPKCS8PrivateKeyInfo;
      fafafa.ssl.openssl.api.pkcs.EVP_PKCS82PKEY := LOrigEVPPKCS82PKEY;
      fafafa.ssl.openssl.api.pkcs.d2i_X509_SIG := LOrigD2IX509Sig;
      fafafa.ssl.openssl.api.pkcs12.PKCS8_decrypt := LOrigPKCS8Decrypt;
      d2i_RSAPrivateKey := LOrigD2IRSAPrivateKey;
