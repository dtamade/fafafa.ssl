...
openssl_ctx="$root_dir/src/fafafa.ssl.openssl.context.pas"
openssl_lib="$root_dir/src/fafafa.ssl.openssl.backed.pas"
winssl_lib="$root_dir/src/fafafa.ssl.winssl.lib.pas"
...
require_present "$openssl_lib" "Result.SupportsPKCS11 := True;" \
...
echo "[PASS] hardware-key capability truth remains aligned with shipped source and active WinSSL docs"
