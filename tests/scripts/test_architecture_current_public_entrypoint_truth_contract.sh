...
require_contains 'fafafa.ssl.openssl.backed.pas'
require_contains 'fafafa.ssl.freepascal.'
require_contains 'fafafa.ssl.native_handle'
...
require_absent 'fafafa.ssl.openssl.lib.pas'
