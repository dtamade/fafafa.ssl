...
OUT_FILE="$ROOT_DIR/tmp/test_focused_style_contract_factory_and_selector.out"
...
echo "[TEST] focused style contract for factory + backend selector"
...
echo "[PASS] focused style contract for factory + backend selector passed"
