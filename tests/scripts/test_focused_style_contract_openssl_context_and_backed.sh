...
OUT_FILE="$ROOT_DIR/tmp/test_focused_style_contract_openssl_context_and_backed.out"
...
echo "[TEST] focused style contract for openssl context + backed"
...
echo "[PASS] focused style contract for openssl context + backed passed"
