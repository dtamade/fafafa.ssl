...
require("  fafafa.ssl.context.builder;" in builder, "builder quickstart must keep the builder unit import")
require("  Ctx: ISSLContext;" in builder, "builder quickstart must keep the current facade-exposed ISSLContext type")
require("fafafa.ssl.base," not in builder, "builder quickstart must stop teaching direct base-unit imports")
