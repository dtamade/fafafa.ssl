...
WORK_REL="tmp/test_wave_b_ci_gate_examples_warning_override_$$"
...
RUN_ID="wave_b_ci_gate_warning_override_$$"
...
echo "[TEST] wave b ci gate examples warning explicit override contract"
...
assert_contains "$SUMMARY_FILE" "- Report: \`$CUSTOM_REL\`"
assert_contains "$SUMMARY_FILE" "- Warning: \`$WARNING_TEXT\`"

echo "[PASS] wave b ci gate examples warning explicit override contract passed"
