...
WORK_REL="tmp/test_wave_b_evidence_dryrun_examples_observability_$$"
WORK_DIR="$ROOT_DIR/$WORK_REL"
REPORTS_REL="$WORK_REL/reports"
REPORTS_DIR="$ROOT_DIR/$REPORTS_REL"
RUN_ID="wave_b_evidence_dryrun_$$"
...
echo "[TEST] wave-b evidence dry-run examples observability contract"
...
echo "[PASS] wave-b evidence dry-run examples observability contract passed"
