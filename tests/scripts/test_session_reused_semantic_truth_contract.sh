...
mbedtls_file="src/fafafa.ssl.mbedtls.connection.pas"
openssl_file="src/fafafa.ssl.openssl.connection.pas"
wolfssl_file="src/fafafa.ssl.wolfssl.connection.pas"
freepascal_file="src/fafafa.ssl.freepascal.connection.pas"
