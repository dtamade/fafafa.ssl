...
WORK_REL="tmp/test_wave_b_b2_consistency_cross_summary_run_id_closed_$(date +%s)"
WORK_DIR="$ROOT_DIR/$WORK_REL"
RUN_ID="consistency_cross_summary_run_id_closed_truth"
BAD_RUN_ID="consistency_cross_summary_run_id_closed_other"
...
echo "[PASS] wave-b-b2 consistency cross_summary run-id closed next-actions contract passed"
