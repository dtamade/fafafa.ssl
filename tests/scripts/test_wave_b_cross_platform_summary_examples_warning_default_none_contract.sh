...
WORK_REL="tmp/test_wave_b_cross_examples_warning_none_$$"
WORK_DIR="$ROOT_DIR/$WORK_REL"
REPORTS_REL="$WORK_REL/reports"
REPORTS_DIR="$ROOT_DIR/$REPORTS_REL"
RUN_ID="wave_b_cross_warning_none_$$"
...
echo "[TEST] wave-b cross-platform summary examples warning default none contract"
...
echo "[PASS] wave-b cross-platform summary examples warning default none contract passed"
