...
OUT_FILE="$ROOT_DIR/tmp/test_focused_style_contract_x509v3.out"
...
echo "[TEST] focused style contract for openssl api x509v3"
...
target='src/fafafa.ssl.openssl.api.x509v3.pas'
...
echo "[PASS] focused style contract for openssl api x509v3 passed"
