...
OUT_FILE="$ROOT_DIR/tmp/test_focused_style_contract_openssl_api_ts.out"
...
echo "[TEST] focused style contract for openssl api ts"
...
target='src/fafafa.ssl.openssl.api.ts.pas'
...
echo "[PASS] focused style contract for openssl api ts passed"
