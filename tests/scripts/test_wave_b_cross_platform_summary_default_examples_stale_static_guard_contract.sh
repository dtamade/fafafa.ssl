...
WORK_REL="tmp/test_wave_b_cross_examples_stale_guard_$$"
WORK_DIR="$ROOT_DIR/$WORK_REL"
REPORTS_REL="$WORK_REL/reports"
REPORTS_DIR="$ROOT_DIR/$REPORTS_REL"
RUN_ID="wave_b_cross_stale_guard_$$"
OTHER_RUN="wave_b_cross_stale_other_$$"
...
echo "[TEST] wave-b cross-platform summary default examples stale static guard contract"
...
assert_contains "$OUTPUT_FILE" "| total | n/a |"
assert_contains "$OUTPUT_FILE" "| pass_rate | n/a |"

echo "[PASS] wave-b cross-platform summary default examples stale static guard contract passed"
