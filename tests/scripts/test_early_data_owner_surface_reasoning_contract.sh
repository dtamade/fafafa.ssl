...
reject_fixed '  fafafa.ssl.base,' \
  "$guide" \
  "EARLY_DATA_GUIDE active examples must stop teaching fafafa.ssl.base split imports"
reject_fixed '  fafafa.ssl.factory;' \
  "$guide" \
  "EARLY_DATA_GUIDE active examples must stop teaching fafafa.ssl.factory split imports"
