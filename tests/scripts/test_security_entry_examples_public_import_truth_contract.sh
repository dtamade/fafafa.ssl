...
require_fixed "$cert_pinning_simple" "fafafa.ssl.cert.pinning" \
...
require_fixed "$security_demo" "fafafa.ssl.context.builder" \
  "security_enhancements_demo must keep the current builder unit"
require_fixed "$security_demo" "fafafa.ssl.cert.pinning" \
  "security_enhancements_demo must keep the specialized pinning unit"
require_fixed "$security_demo" "fafafa.ssl.cert.rotation" \
