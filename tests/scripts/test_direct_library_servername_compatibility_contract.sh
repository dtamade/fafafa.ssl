...
check_file "src/fafafa.ssl.openssl.backed.pas" "TOpenSSLLibrary"
check_file "src/fafafa.ssl.freepascal.lib.pas" "TFreePascalSSLLibrary"
check_file "src/fafafa.ssl.winssl.lib.pas" "TWinSSLLibrary"
check_file "src/fafafa.ssl.mbedtls.lib.pas" "TMbedTLSLibrary"
check_file "src/fafafa.ssl.wolfssl.lib.pas" "TWolfSSLLibrary"
