...
declare -a checks=(
  ...
  "docs/guides/INTEGRATION_GUIDE.md|LClientConn: ISSLClientConnection;"
  "docs/guides/INTEGRATION_GUIDE.md|LClientConn := LConn as ISSLClientConnection;"
  "docs/guides/INTEGRATION_GUIDE.md|LClientConn.SetServerName('example.com');"
