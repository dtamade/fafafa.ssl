...
WORK_REL="tmp/test_wave_b_handoff_dryrun_examples_observability_$$"
WORK_DIR="$ROOT_DIR/$WORK_REL"
REPORTS_REL="$WORK_REL/reports"
REPORTS_DIR="$ROOT_DIR/$REPORTS_REL"
RUN_ID="wave_b_handoff_dryrun_$$"
...
echo "[TEST] wave-b handoff dry-run examples observability contract"
...
OUT_DEFAULT="$(FAFAFA_WAVE_B_REPORTS_DIR="$REPORTS_REL" bash "$SCRIPT" --run-id "$RUN_ID" --linux-summary "$REPORTS_REL/wave_b_ci_gate_summary_${RUN_ID}.md" --dry-run 2>&1)"
...
OUT_OVERRIDE="$(FAFAFA_WAVE_B_REPORTS_DIR="$REPORTS_REL" FAFAFA_WAVE_B_EXAMPLES_REPORT_REL="$OVERRIDE_REL" bash "$SCRIPT" --run-id "$RUN_ID" --linux-summary "$REPORTS_REL/wave_b_ci_gate_summary_${RUN_ID}.md" --dry-run 2>&1)"
...
echo "[PASS] wave-b handoff dry-run examples observability contract passed"
