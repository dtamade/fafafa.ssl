...
WORK_REL="tmp/test_wave_b_ci_gate_examples_warning_none_$$"
...
echo "[TEST] wave b ci gate examples warning default none contract"
...
assert_contains "$SUMMARY_FILE" "- Warning: \`none\`"

echo "[PASS] wave b ci gate examples warning default none contract passed"
