...
WORK_REL="tmp/test_wave_b_handoff_examples_selection_override_$$"
WORK_DIR="$ROOT_DIR/$WORK_REL"
REPORTS_REL="$WORK_REL/reports"
REPORTS_DIR="$ROOT_DIR/$REPORTS_REL"
RUN_ID="wave_b_handoff_selection_override_$$"
...
echo "[TEST] wave-b handoff examples selection explicit override contract"
...
assert_contains "$CONSISTENCY_FILE" "- linux_examples_selection: explicit_override"

echo "[PASS] wave-b handoff examples selection explicit override contract passed"
