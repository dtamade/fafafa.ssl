...
SELECTOR_SRC="$ROOT_DIR/src/fafafa.ssl.backend.selector.pas"
BUILDER_SRC="$ROOT_DIR/src/fafafa.ssl.context.builder.pas"
FREEPASCAL_LIB="$ROOT_DIR/src/fafafa.ssl.freepascal.lib.pas"
