...
openssl_file="src/fafafa.ssl.openssl.backed.pas"
wolfssl_file="src/fafafa.ssl.wolfssl.lib.pas"
winssl_file="src/fafafa.ssl.winssl.lib.pas"
freepascal_file="src/fafafa.ssl.freepascal.lib.pas"
mbedtls_file="src/fafafa.ssl.mbedtls.lib.pas"
