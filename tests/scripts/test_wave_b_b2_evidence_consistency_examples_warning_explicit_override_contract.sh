...
WORK_REL="tmp/test_wave_b_evidence_examples_warning_override_$$"
WORK_DIR="$ROOT_DIR/$WORK_REL"
REPORTS_REL="$WORK_REL/reports"
REPORTS_DIR="$ROOT_DIR/$REPORTS_REL"
RUN_ID="wave_b_evidence_warning_override_$$"
OVERRIDE_REL="$REPORTS_REL/custom_examples_override.json"
OVERRIDE_FILE="$ROOT_DIR/$OVERRIDE_REL"
OUTPUT_REL="$REPORTS_REL/evidence_warning_override_${RUN_ID}.md"
...
echo "[TEST] wave-b evidence examples warning explicit override contract"
...
assert_contains "$OUTPUT_FILE" "- linux_examples_warning: $WARNING_TEXT"

echo "[PASS] wave-b evidence examples warning explicit override contract passed"
