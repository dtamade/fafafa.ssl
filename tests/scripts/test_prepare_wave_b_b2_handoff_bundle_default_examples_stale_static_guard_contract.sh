...
WORK_REL="tmp/test_wave_b_handoff_examples_stale_guard_$$"
WORK_DIR="$ROOT_DIR/$WORK_REL"
REPORTS_REL="$WORK_REL/reports"
REPORTS_DIR="$ROOT_DIR/$REPORTS_REL"
RUN_ID="wave_b_handoff_stale_guard_$$"
OTHER_RUN="wave_b_handoff_stale_other_$$"
...
echo "[TEST] wave-b b2 handoff default examples stale static guard contract"
...
assert_contains "$CONSISTENCY_FILE" "| linux_examples_json | $REPORTS_REL/examples_compile_ci_gate_${RUN_ID}.json | NO | n/a | n/a | missing |"
assert_not_contains "$CONSISTENCY_FILE" "| linux_examples_json | $REPORTS_REL/examples_compile_ci_gate.json |"
assert_contains "$CONSISTENCY_FILE" "- consistency_status: **INCONSISTENT**"

echo "[PASS] wave-b b2 handoff default examples stale static guard contract passed"
