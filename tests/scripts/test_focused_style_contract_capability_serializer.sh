...
OUT_FILE="$ROOT_DIR/tmp/test_focused_style_contract_capability_serializer.out"
...
echo "[TEST] focused style contract for capability serializer"
...
echo "[PASS] focused style contract for capability serializer passed"
