...
FACTORY_FILE="$ROOT_DIR/src/fafafa.ssl.factory.pas"
MBEDTLS_FILE="$ROOT_DIR/src/fafafa.ssl.mbedtls.lib.pas"
WOLFSSL_FILE="$ROOT_DIR/src/fafafa.ssl.wolfssl.lib.pas"
