...
WORK_REL="tmp/test_wave_b_cross_examples_warning_override_$$"
WORK_DIR="$ROOT_DIR/$WORK_REL"
REPORTS_REL="$WORK_REL/reports"
REPORTS_DIR="$ROOT_DIR/$REPORTS_REL"
RUN_ID="wave_b_cross_warning_override_$$"
...
echo "[TEST] wave-b cross-platform summary examples warning explicit override contract"
...
echo "[PASS] wave-b cross-platform summary examples warning explicit override contract passed"
