...
OUT_FILE="$ROOT_DIR/tmp/test_focused_style_contract_cert_utils.out"
...
echo "[TEST] focused style contract for cert utils"
...
target='src/fafafa.ssl.cert.utils.pas'
...
echo "[PASS] focused style contract for cert utils passed"
