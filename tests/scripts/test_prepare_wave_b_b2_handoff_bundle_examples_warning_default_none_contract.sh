...
WORK_REL="tmp/test_wave_b_handoff_examples_warning_none_$$"
WORK_DIR="$ROOT_DIR/$WORK_REL"
REPORTS_REL="$WORK_REL/reports"
REPORTS_DIR="$ROOT_DIR/$REPORTS_REL"
RUN_ID="wave_b_handoff_warning_none_$$"
...
echo "[TEST] wave-b handoff examples warning default none contract"
...
assert_contains "$BUNDLE_FILE" "- linux_examples_warning: none"
assert_contains "$CONSISTENCY_FILE" "- linux_examples_warning: none"

echo "[PASS] wave-b handoff examples warning default none contract passed"
