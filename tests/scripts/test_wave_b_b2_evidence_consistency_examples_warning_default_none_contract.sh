...
WORK_REL="tmp/test_wave_b_evidence_examples_warning_none_$$"
WORK_DIR="$ROOT_DIR/$WORK_REL"
REPORTS_REL="$WORK_REL/reports"
REPORTS_DIR="$ROOT_DIR/$REPORTS_REL"
RUN_ID="wave_b_evidence_warning_none_$$"
OUTPUT_REL="$REPORTS_REL/evidence_warning_none_${RUN_ID}.md"
...
echo "[TEST] wave-b evidence examples warning default none contract"
...
assert_contains "$OUTPUT_FILE" "- linux_examples_selection: run_scoped_exact"
assert_contains "$OUTPUT_FILE" "- linux_examples_warning: none"

echo "[PASS] wave-b evidence examples warning default none contract passed"
