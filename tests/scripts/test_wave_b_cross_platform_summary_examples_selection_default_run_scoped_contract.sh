...
WORK_REL="tmp/test_wave_b_cross_examples_selection_default_$$"
WORK_DIR="$ROOT_DIR/$WORK_REL"
REPORTS_REL="$WORK_REL/reports"
REPORTS_DIR="$ROOT_DIR/$REPORTS_REL"
RUN_ID="wave_b_cross_selection_default_$$"
...
echo "[TEST] wave-b cross-platform summary examples selection default run-scoped contract"
...
echo "[PASS] wave-b cross-platform summary examples selection default run-scoped contract passed"
