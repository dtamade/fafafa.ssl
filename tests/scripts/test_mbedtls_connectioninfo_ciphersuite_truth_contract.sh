...
base_file="$ROOT_DIR/src/fafafa.ssl.mbedtls.base.pas"
api_file="$ROOT_DIR/src/fafafa.ssl.mbedtls.api.pas"
conn_file="$ROOT_DIR/src/fafafa.ssl.mbedtls.connection.pas"
shared_file="$ROOT_DIR/src/fafafa.ssl.connection.base.pas"
