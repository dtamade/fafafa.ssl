...
API_FILE="$ROOT_DIR/src/fafafa.ssl.winssl.api.pas"
CONNECTION_FILE="$ROOT_DIR/src/fafafa.ssl.winssl.connection.pas"
...
[[ -f "$API_FILE" ]] || fail "missing file: src/fafafa.ssl.winssl.api.pas"
[[ -f "$CONNECTION_FILE" ]] || fail "missing file: src/fafafa.ssl.winssl.connection.pas"
