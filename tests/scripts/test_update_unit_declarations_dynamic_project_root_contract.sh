...
SCRIPT="$ROOT_DIR/scripts/update_unit_declarations.ps1"
...
echo "[TEST] update_unit_declarations dynamic project root contract"
...
echo "[PASS] update_unit_declarations dynamic project root contract passed"
