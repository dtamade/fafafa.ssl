{**
 * Test: WolfSSL Certificate Unit Tests
 * Purpose: High-coverage unit tests for TWolfSSLCertificate and TWolfSSLCertificateStore
 *
 * Test Categories:
...
program test_wolfssl_certificate_unit;
  ...
  begin
    try
      ...
      begin
        ...
        LCert.SaveToPEM;  // Just verify it doesn't crash
      end
      else
...
begin
  ...
  try
    LCert := TWolfSSLCertificate.Create;
    LIssuer := TWolfSSLCertificate.Create;
...
begin
  WriteLn('WolfSSL Certificate Unit Tests');
  WriteLn('===============================');
  WriteLn('High-coverage tests for TWolfSSLCertificate and TWolfSSLCertificateStore');
  WriteLn('');
  ...
  try
    ...
    if GLibraryAvailable then
      ...
      WriteLn('WolfSSL library: Not available (tests will use empty certificates)');
  except
    on E: Exception do
    begin
  ...
  WriteLn('');
  WriteLn('========================================');
  WriteLn('WolfSSL Certificate Unit Test Summary');
  WriteLn('========================================');
