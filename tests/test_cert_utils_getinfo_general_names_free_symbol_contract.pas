program test_cert_utils_getinfo_general_names_free_symbol_contract;
...
procedure AssertGeneralNamesFreeGuardInfo(
  const AName: string;
...
begin
  ...
  begin
    try
      AssertGeneralNamesFreeGuardInfo(
        AName,
        LInfo,
        AExpectedSubject,
        AExpectedIssuer,
...
procedure TestGetInfoShouldFailGracefullyWhenGeneralNamesFreeIsUnavailable;
var
  LFixturePEM: string;
  ...
  LOriginalGeneralNamesFree: TGENERAL_NAMES_free;
begin
  WriteLn;
  WriteLn('=== Certificate utils GetInfo GENERAL_NAMES_free symbol guard ===');
  ...
  begin
    MarkSkip('certificate utils getinfo GENERAL_NAMES_free symbol contract',
  ...
  try
    ...
    LOriginalGeneralNamesFree := GENERAL_NAMES_free;
    GENERAL_NAMES_free := nil;
    try
      AssertGetInfoSafeDegrade(
        'GetInfo when GENERAL_NAMES_free is unavailable',
        LFixturePEM,
        LExpectedSubject,
        LExpectedIssuer,
        LExpectedVersion,
      ...
      GENERAL_NAMES_free := LOriginalGeneralNamesFree;
    end;
  finally
...
begin
  WriteLn('========================================');
  WriteLn('Certificate Utils GetInfo GENERAL_NAMES_free Symbol Contract Test');
  WriteLn('========================================');
  ...
  try
    ...
    if SkippedTests = 0 then
      TestGetInfoShouldFailGracefullyWhenGeneralNamesFreeIsUnavailable;
