program test_cert_utils_getinfo_general_name_get0_value_symbol_contract;
...
procedure AssertGeneralNameValueGuardInfo(
  const AName: string;
...
begin
  ...
  begin
    try
      AssertGeneralNameValueGuardInfo(
        AName,
        LInfo,
        AExpectedSubject,
        AExpectedIssuer,
...
procedure TestGetInfoShouldFailGracefullyWhenGeneralNameGet0ValueIsUnavailable;
var
  LFixturePEM: string;
  ...
  LOriginalGeneralNameGet0Value: TGENERAL_NAME_get0_value;
begin
  WriteLn;
  WriteLn('=== Certificate utils GetInfo GENERAL_NAME_get0_value symbol guard ===');
  ...
  if (not Assigned(BIO_new_mem_buf)) or
     ...
     (not Assigned(GENERAL_NAMES_free)) then
  begin
    MarkSkip('certificate utils getinfo GENERAL_NAME_get0_value symbol contract',
  ...
  LOriginalGeneralNameGet0Value := GENERAL_NAME_get0_value;
  GENERAL_NAME_get0_value := nil;
  try
    AssertGetInfoSafeDegrade(
      'GetInfo when GENERAL_NAME_get0_value is unavailable',
      LFixturePEM,
      LExpectedSubject,
      LExpectedIssuer,
      LExpectedVersion,
    ...
    GENERAL_NAME_get0_value := LOriginalGeneralNameGet0Value;
  end;
end;

begin
  WriteLn('========================================');
  WriteLn('Certificate Utils GetInfo GENERAL_NAME_get0_value Symbol Contract Test');
  WriteLn('========================================');
  ...
  try
    ...
    if SkippedTests = 0 then
      TestGetInfoShouldFailGracefullyWhenGeneralNameGet0ValueIsUnavailable;
