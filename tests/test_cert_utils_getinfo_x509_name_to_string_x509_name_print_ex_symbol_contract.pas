program test_cert_utils_getinfo_x509_name_to_string_x509_name_print_ex_symbol_contract;
...
procedure AssertNameConversionPrintGuardInfo(
  const AName: string;
...
begin
  ...
  begin
    try
      AssertNameConversionPrintGuardInfo(
        AName,
        LInfo,
        AExpectedVersion,
        AExpectedNotBefore,
...
procedure TestGetInfoShouldFailGracefullyWhenX509NameToStringPrintHelperIsUnavailable;
var
  LFixturePEM: string;
  ...
  LOriginalX509NamePrintEx: TX509_NAME_print_ex;
begin
  WriteLn;
  WriteLn('=== Certificate utils GetInfo X509NameToString X509_NAME_print_ex symbol guard ===');
  ...
  begin
    MarkSkip('certificate utils getinfo X509NameToString X509_NAME_print_ex symbol contract',
  ...
  try
    ...
    LOriginalX509NamePrintEx := X509_NAME_print_ex;
    X509_NAME_print_ex := nil;
    try
      AssertGetInfoSafeDegrade(
        'GetInfo when X509NameToString X509_NAME_print_ex is unavailable',
        LFixturePEM,
        LExpectedVersion,
        LExpectedNotBefore,
        LExpectedNotAfter,
      ...
      X509_NAME_print_ex := LOriginalX509NamePrintEx;
    end;
  finally
...
begin
  WriteLn('========================================');
  WriteLn('Certificate Utils GetInfo X509NameToString X509_NAME_print_ex Symbol Contract Test');
  WriteLn('========================================');
  ...
  try
    ...
    if SkippedTests = 0 then
      TestGetInfoShouldFailGracefullyWhenX509NameToStringPrintHelperIsUnavailable;
