{**
 * Test: WolfSSL Connection Unit Tests
 * Purpose: High-coverage unit tests for TWolfSSLConnection
 *
 * Test Categories:
...
program test_wolfssl_connection_unit;
...
begin
  ...
  try
    ...
    try
      ...
      LConn.GetError(WOLFSSL_ERROR_WANT_READ);
    except
...
begin
  WriteLn('WolfSSL Connection Unit Tests');
  WriteLn('==============================');
  WriteLn('High-coverage tests for TWolfSSLConnection');
  WriteLn('');
  ...
  WriteLn('');
  WriteLn('========================================');
  WriteLn('WolfSSL Connection Unit Test Summary');
  WriteLn('========================================');
