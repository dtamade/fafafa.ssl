{**
 * Test: WinSSL Connection Unit Tests
 * Purpose: High-coverage unit tests for TWinSSLConnection and TWinSSLSession
 *
 * Test Categories:
...
program test_winssl_connection_unit;
...
begin
  WriteLn('WinSSL Connection Unit Tests');
  WriteLn('=============================');
  WriteLn('High-coverage tests for TWinSSLConnection and TWinSSLSession');
  WriteLn('');
  ...
  try
    ...
    if GLibraryAvailable then
      ...
      WriteLn('WinSSL library: Not available');
  except
    on E: Exception do
    begin
  ...
  WriteLn('');
  WriteLn('========================================');
  WriteLn('WinSSL Connection Unit Test Summary');
  WriteLn('========================================');
