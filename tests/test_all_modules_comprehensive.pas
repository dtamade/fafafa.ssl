...
begin
  ...
  AddModule('utils', 'fafafa.ssl.openssl.utils', 'Core', 1);
  AddModule('core', 'fafafa.ssl.openssl.core', 'Core', 1);
  AddModule('api', 'fafafa.ssl.openssl.api', 'Core', 1);
  AddModule('err', 'fafafa.ssl.openssl.err', 'Core', 1);
  
  // Basic Crypto (Priority 1)
  AddModule('evp', 'fafafa.ssl.openssl.evp', 'Crypto-Core', 1);
  AddModule('bn', 'fafafa.ssl.openssl.bn', 'Crypto-Core', 1);
  AddModule('bio', 'fafafa.ssl.openssl.bio', 'Crypto-Core', 1);
  AddModule('rand', 'fafafa.ssl.openssl.rand', 'Crypto-Core', 1);
  
  // Hash Algorithms (Priority 1)
  AddModule('md', 'fafafa.ssl.openssl.md', 'Hash', 1);
  AddModule('sha', 'fafafa.ssl.openssl.sha', 'Hash', 1);
  AddModule('sha3', 'fafafa.ssl.openssl.sha3', 'Hash', 1);
  AddModule('sha3.evp', 'fafafa.ssl.openssl.sha3.evp', 'Hash', 1);
  AddModule('blake2', 'fafafa.ssl.openssl.blake2', 'Hash', 1);
  AddModule('sm', 'fafafa.ssl.openssl.sm', 'Hash', 1);
  
  // Symmetric Ciphers (Priority 1)
  AddModule('aes', 'fafafa.ssl.openssl.aes', 'Cipher', 1);
  AddModule('des', 'fafafa.ssl.openssl.des', 'Cipher', 1);
  ...
  AddModule('rsa', 'fafafa.ssl.openssl.rsa', 'PKI', 1);
  AddModule('dsa', 'fafafa.ssl.openssl.dsa', 'PKI', 1);
  AddModule('dh', 'fafafa.ssl.openssl.dh', 'PKI', 1);
  AddModule('ec', 'fafafa.ssl.openssl.ec', 'PKI', 1);
  AddModule('ecdh', 'fafafa.ssl.openssl.ecdh', 'PKI', 1);
  AddModule('ecdsa', 'fafafa.ssl.openssl.ecdsa', 'PKI', 1);
  
  // MAC & KDF (Priority 1)
  AddModule('hmac', 'fafafa.ssl.openssl.hmac', 'MAC', 1);
  AddModule('cmac', 'fafafa.ssl.openssl.cmac', 'MAC', 1);
  AddModule('cmac.evp', 'fafafa.ssl.openssl.cmac.evp', 'MAC', 1);
  AddModule('kdf', 'fafafa.ssl.openssl.kdf', 'KDF', 1);
  ...
  AddModule('modes', 'fafafa.ssl.openssl.modes', 'Modes', 1);
  
  // X.509 & PKI (Priority 1)
  AddModule('x509', 'fafafa.ssl.openssl.x509', 'PKI', 1);
  AddModule('x509v3', 'fafafa.ssl.openssl.x509v3', 'PKI', 1);
  AddModule('asn1', 'fafafa.ssl.openssl.asn1', 'Encoding', 1);
  AddModule('pem', 'fafafa.ssl.openssl.pem', 'Encoding', 1);
  
  // PKCS Standards (Priority 2)
  AddModule('pkcs', 'fafafa.ssl.openssl.pkcs', 'PKCS', 2);
  AddModule('pkcs7', 'fafafa.ssl.openssl.pkcs7', 'PKCS', 2);
  AddModule('pkcs12', 'fafafa.ssl.openssl.pkcs12', 'PKCS', 2);
  AddModule('cms', 'fafafa.ssl.openssl.cms', 'PKCS', 2);
  
  // SSL/TLS (Priority 2)
  AddModule('ssl', 'fafafa.ssl.openssl.ssl', 'SSL', 2);
  
  // Certificate Services (Priority 2)
  AddModule('ocsp', 'fafafa.ssl.openssl.ocsp', 'Certificate', 2);
  AddModule('ct', 'fafafa.ssl.openssl.ct', 'Certificate', 2);
  AddModule('ts', 'fafafa.ssl.openssl.ts', 'Certificate', 2);
  
  // Advanced Features (Priority 2-3)
  AddModule('engine', 'fafafa.ssl.openssl.engine', 'Advanced', 2);
  AddModule('provider', 'fafafa.ssl.openssl.provider', 'Advanced', 1);
  AddModule('param', 'fafafa.ssl.openssl.param', 'Advanced', 1);
  AddModule('store', 'fafafa.ssl.openssl.store', 'Advanced', 2);
  AddModule('async', 'fafafa.ssl.openssl.async', 'Advanced', 3);
  AddModule('comp', 'fafafa.ssl.openssl.comp', 'Advanced', 3);
  
  // Utilities (Priority 2-3)
  AddModule('buffer', 'fafafa.ssl.openssl.buffer', 'Utility', 2);
  AddModule('stack', 'fafafa.ssl.openssl.stack', 'Utility', 2);
  AddModule('lhash', 'fafafa.ssl.openssl.lhash', 'Utility', 2);
  AddModule('obj', 'fafafa.ssl.openssl.obj', 'Utility', 2);
  AddModule('conf', 'fafafa.ssl.openssl.conf', 'Utility', 2);
  AddModule('txt_db', 'fafafa.ssl.openssl.txt_db', 'Utility', 3);
  AddModule('ui', 'fafafa.ssl.openssl.ui', 'Utility', 3);
  AddModule('dso', 'fafafa.ssl.openssl.dso', 'Utility', 3);
  AddModule('srp', 'fafafa.ssl.openssl.srp', 'Utility', 3);
  AddModule('thread', 'fafafa.ssl.openssl.thread', 'Utility', 2);
  AddModule('crypto', 'fafafa.ssl.openssl.crypto', 'Utility', 1);
  AddModule('rand_old', 'fafafa.ssl.openssl.rand_old', 'Utility', 3);
end;
