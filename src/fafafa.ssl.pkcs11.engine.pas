...
type
  ...
  private
    ...
    FUIMethod: fafafa.ssl.openssl.api.ui.PUI_METHOD;  // 用于 PIN 回调的 UI 方法
    ...
    function CreatePINUIMethod: fafafa.ssl.openssl.api.ui.PUI_METHOD;
...
function PKCS11_UI_reader(ui: fafafa.ssl.openssl.api.ui.PUI;
  uis: fafafa.ssl.openssl.api.ui.PUI_STRING): Integer; cdecl;
var
  StrType: Integer;
  CallbackPIN: string;
...
function PKCS11_UI_writer(ui: fafafa.ssl.openssl.api.ui.PUI;
  uis: fafafa.ssl.openssl.api.ui.PUI_STRING): Integer; cdecl;
var
  StrType: Integer;
begin
...
function TEngineBackend.CreatePINUIMethod: fafafa.ssl.openssl.api.ui.PUI_METHOD;
begin
  Result := nil;
...
var
  ...
  PINAnsi: AnsiString;
  UIMethod: fafafa.ssl.openssl.api.ui.PUI_METHOD;
begin
  Result := nil;
  ...
  UIMethod := fafafa.ssl.openssl.api.ui.PUI_METHOD(FUIMethod);
  ...
  try
    ...
    Result := ENGINE_load_private_key(FEngine, PAnsiChar(KeyIDAnsi),
      fafafa.ssl.openssl.api.engine.PUI_METHOD(UIMethod), @FCallbackData);
