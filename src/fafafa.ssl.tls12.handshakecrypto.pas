unit fafafa.ssl.tls12.handshakecrypto;
...
function DeriveKeyBlock(const AMasterSecret, AServerRandom, AClientRandom: TBytes;
  AKeyLen, AIVLen: Integer; AUseSHA384: Boolean): TTLS12KeyBlock;
var
...
begin
  Result := DeriveKeyBlock(AMasterSecret, AServerRandom, AClientRandom, AKeyLen, AIVLen, False);
end;
...
begin
  Result := DeriveKeyBlock(AMasterSecret, AServerRandom, AClientRandom, AKeyLen, AIVLen, True);
end;
