...
```bash
bash /home/dtamade/projects/fafafa.ssl/tests/benchmarks/run_all_benchmarks.sh --iterations 50 --tls-iterations 20 --output /home/dtamade/projects/fafafa.ssl/tests/benchmarks/results --skip-tls
```

## 输出文件

- 汇总报告：`/home/dtamade/projects/fafafa.ssl/tests/benchmarks/results/benchmark_summary_20260207_030221.txt`
...
aes_gcm_dec_1kb                  0.020        0.000        1.000      50000.0
aes_gcm_dec_64b                  0.000        0.000        0.000          0.0
aes_gcm_enc_16kb                 0.000        0.000        0.000          0.0
aes_gcm_enc_1kb                  0.000        0.000        0.000          0.0
aes_gcm_enc_64b                  0.020        0.000        1.000      50000.0
generate_key_128bit              0.000        0.000        0.000          0.0
generate_key_256bit              0.000        0.000        0.000          0.0
secure_random_16kb               0.000        0.000        0.000          0.0
secure_random_1kb                0.000        0.000        0.000          0.0
secure_random_64b                0.020        0.000        1.000      50000.0
sha256_16kb                      0.040        0.000        1.000      25000.0
...
=== benchmark_random_pool_20260207_030221.log ===
...
Random Pool Enabled (1KB x 10000)       :    40.00 ms  (    244.14 MB/s)
  ...
  Refill count: 1250
Direct Generation (1KB x 10000)         :    83.00 ms  (    117.66 MB/s)
...
Random Pool Enabled (8KB x 1000)        :    31.00 ms  (    252.02 MB/s)
  ...
  Cache misses: 1000
Direct Generation (8KB x 1000)          :    30.00 ms  (    260.42 MB/s)
