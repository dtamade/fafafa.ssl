...
| field | value |
|------|-------|
| policy_id | 20260207_082056 |
| generated_at | 2026-02-07 08:20:56 +0800 |
...
| linkage-payload | mismatch=0, missing=0 | mismatch/missing 必须为 0 | 1 && echo pass || echo fail |
| writeback-change-coverage | signaled=14, changed=0 | signaled>0 时 changed 必须>0 | 0 && echo pass || echo fail |
| trend-alert-load | trend_alerts=0 | alert>0 时至少 reinforce | 0 && echo reinforce || echo stable |
