...
|------|-------|-----------|--------|
| latest_continuity_file | test-reports/wave_c_b123_local_first_continuity_20260209_045450.md | required | PASS |
| continuity_state | LOCAL_READY | LOCAL_READY | PASS |
| continuity_age_hours | 0 | <= 24 | PASS |
| latest_bundle_file | test-reports/wave_c_quick_sprint_bundle_20260208_173726.md | required | PASS |
| bundle_overall | PASS | PASS | PASS |
| bundle_age_hours | 11 | <= 72 | PASS |
| previous_b124_gap_hours | 1 | <= 24 | PASS |
