...
- Run ID: `20260208_022636`
- Generated At: `2026-02-08 02:29:15 +0800`
...
|------|-----------|--------|-----|
| compile_all_modules | `0` | **PASS** | `test-reports/wave_b_compile_20260208_022636.log` |
| run_all_module_tests | `0` | **PASS** | `test-reports/wave_b_modules_20260208_022636.log` |
| verify_examples_compile | `1` | **PASS** | `test-reports/wave_b_examples_20260208_022636.log` |

## Examples Gate Metrics

- Report: `test-reports/examples_compile_ci_gate.json`
- Threshold: `80.0`
- Summary: `passed=62, failed=9, skipped=4, total=75, pass_rate=87.3`
