...
- run_id: 20260316_guard2
- generated_at: 2026-03-16 20:24:10 +0800
...
|------|-------|-----------|--------|
| latest_continuity_file | tmp/test-reports/wave_c_b123_local_first_continuity_20260316_live.md | required | PASS |
| continuity_state | LOCAL_READY | LOCAL_READY | PASS |
| continuity_age_hours | 8 | <= 24 | PASS |
| latest_bundle_file | tmp/test-reports/wave_c_quick_sprint_bundle_20260315_unified.md | required | PASS |
| bundle_overall | PASS | PASS | PASS |
| bundle_age_hours | 25 | <= 72 | PASS |
| previous_b124_gap_hours | 8 | <= 24 | PASS |
